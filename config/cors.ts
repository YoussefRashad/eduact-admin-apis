...
const corsConfig: CorsConfig = {
  ...
  */
  ...
  |
  */
  origin: ['https://admin.eduact.me', 'http://localhost:3000'],
  ...
  */
  ...
  |
  */
  exposeHeaders: ['cache-control', 'content-language', 'content-type', 'expires', 'last-modified', 'pragma', 'Content-Disposition'],
