...
export default class UpdateTestModelValidator {
  ...
  public schema = schema.create({
    id: schema.number([rules.exists({ table: 'test_models', column: 'id' })]),
    name: schema.string.optional(),
    shuffle_questions: schema.boolean.optional(),
    shuffle_answers: schema.boolean.optional(),
    modelQuestions: schema.array.optional([rules.minLength(1)]).members(
